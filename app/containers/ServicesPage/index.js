    ...
    <div>
      ...
      <div className="car_repair">
        ...
        <div className="main_icon">
          ...
          <div className="service_item1">
            <span>
              Собственный алгоритм проверки АКПП. Проверка уровня жидкости и
        ...
        <div className="main_icon">
          ...
          <div className="service_item1">
            <span>
              Проверяем состояние тормозных механизмов, дисков, колодок,
              антиблокировочной, антипробуксовочной систем и антизаноса.{' '}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="main_car_repair">
        <div className="main_icon">
          ...
          <div className="service_item1">
            <span>
              Проверям работу всех электронных систем и механических узлов,
              контролируемых этими системами.
            </span>
          </div>
        </div>
        ...
        <div className="main_icon">
          ...
          <div className="service_item1">
            <span>
              Проверка даты выпуска, напряжения, срока службы и
              работоспособности.{' '}
            </span>
          </div>
        </div>
      ...
      <div className="car_repair">
        ...
        <div className="main_icon">
          <div className="service_item_bottom2">
            <span>
              Это один из самых важных элементов подвески. Они напрямую влияют
              на управляемость автомобиля, на его устойчивость и плавность хода
              автомобиля.{' '}
            </span>
          </div>
          <img src={img5} alt="" />
      ...
      <div className="service_order">
        ...
        <div className="service_order_article">
          ...
          <form>
            <div className="Btn">
              <a className="orderBtn" href="#contact_form">
                Заказать
      ...
      <div className="service_order">
        ...
        <div className="service_order_article">
          ...
          <p>
            ...
            воздействию окружающей среды. Однако наибольший вред автомобилям
            наносит качество наших дорог. Именно поэтому в любой момент может
            понадобиться не только балансировка колес, но и полная их замена.
            Необходимо понимать, что своевременное решение проблемы с колесами
            позволит избежать поломок.
          </p>
          <form>
            <div className="Btn">
      ...
      <div className="service_order">
        ...
        <div className="service_order_article">
          ...
          <hr />
          <p>
            Каждый автомобилист должен помнить, что замена масла в двигателе
            позволяет решить самую главную задачу - замедление процесса износа
            мотора. Если вы будете следить за уровнем масла в двигателе, сможете
            избежать ненужных хлопот, которые могут возникнуть в будущем. От
            выбора во многом зависит способность двигателя выдерживать
